...
for i in range(len(X_list)):
  print(np.corrcoef(X_list[i], pre))
...
ax1.set_title('smoking relationship')
...
ax2.set_title('underweight (bmi) relationship')
...
ax3.set_title('obese (bmi) relationship')
...
ax4.set_title('aged 35 to 39 relationship')
...
ax5.set_title('aged 40 to 44 relationship')
...
ax6.set_title('+45 years relationship')
...
ax7.set_title('caesarian relationship')
...
ax8.set_title('no previous caesarian relationship')
...
ax9.set_title('no previous births relationship')
...
ax10.set_title('no previous live births relationship')
